...
import '../components/widgets/rules-card';
    ...
    return html`
      ...
      >
        ${activeTab === 'dashboard' ? html`
          ...
          <!-- Rules Engine Sidebar (Fixed Overlay) -->
          <rules-card
            .rules=${state.rules}
          ></rules-card>
        ` : ''}
        ...
        ${activeTab === 'transactions' ? html`
          <div class="grid-dashboard scrollable">
            <div class="span-12">
              <budget-table .transactions=${state.transactions}></budget-table>
            </div>
          </div>
        ` : ''}
