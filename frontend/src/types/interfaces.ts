 ...
 */
export type ViewMode = 'category' | 'project' | 'forecast' | 'chat' | 'lifecycle' | 'timeline' | 'insights' | 'simulator';
...
export type ChartData =
    ...
    | Array<{ month: string; amount: number; is_forecast: boolean; lower_bound?: number; upper_bound?: number }>  // Single trend line
    | Record<string, Array<{ month: string; amount: number; is_forecast: boolean; lower_bound?: number; upper_bound?: number }>>;  // Multi-line forecast
...
/**
 * Structured output for Simulator Actions
 */
